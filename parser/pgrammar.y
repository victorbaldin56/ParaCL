...
expr:        expr ADD            expr           { $$ = ast::makeBinOp($1, ast::BinOp::kAdd   , $3); }
           ...
           | ID   ADD_ASSIGN     expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kAdd   , $3)); }
           | ID   SUB_ASSIGN     expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kSub   , $3)); }
           | ID   MUL_ASSIGN     expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kMul   , $3)); }
           | ID   DIV_ASSIGN     expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kDiv   , $3)); }
           | ID   MOD_ASSIGN     expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kMod   , $3)); }
           | ID   BTW_AND_ASSIGN expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kBtwAnd, $3)); }
           | ID   BTW_OR_ASSIGN  expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kBtwOr , $3)); }
           | ID   XOR_ASSIGN     expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kXor   , $3)); }
           | ID   SHL_ASSIGN     expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kShl   , $3)); }
           | ID   SHR_ASSIGN     expr           { $$ = ast::makeAssign($1, ast::makeBinOp($1, ast::BinOp::kShr   , $3)); }
           | expr_un                            { $$ = $1; }
